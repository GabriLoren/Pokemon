...
public class TypeChart {
	// Type chart comes from Bulbapedia type charts
	...
	public static double getAdvantageValue(Types defenseType, Types attackType) {
		if (!defenseType.equals(null)) {
			...
			if (v.equals(EffectValues.INEFFECTIVE)) {
				return 0;
			} else if (v.equals(EffectValues.WEAK)) {
				return 0.5;
			} else if (v.equals(EffectValues.NEUTRAL)) {
				return 1;
			} else {
				return 2;
			}
