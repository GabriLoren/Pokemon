...
public class SeleccionarJugadorController2 {
	...
	@FXML
	public void cargarEntrenador(MouseEvent event) {
		// TODO Autogenerated

		String NombreEntrenador = TxtInsertarJugador.getText().toUpperCase();

		try {
			CargarEntrenador.comprobarUsuarioYCargarlo(NombreEntrenador);
...
//			e.printStackTrace();
			...
			lblMostrarUsuario.setText("Fallo conexión BbDd");
		}
